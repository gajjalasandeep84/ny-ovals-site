...
export default function Womensday() {
  ...
  useEffect(() => {
    const loadedImages = importAll(require.context("../../watermarked/images/womensday", false, /\.(png|jpe?g|svg)$/));
  ...
  return (
    <div className="font-serif">
      ...
      <IntroSection
        icon="👩‍🦰👩‍🦳👩‍⚕️👩‍🏫"
        title="Celebrating Women – Grace, Strength, and Endless Inspiration"
        subtitle={
          <>
            <p>From vibrant decor to unforgettable moments, let Fiesta Event Decor help you honor the incredible women in your life. </p>
            <p className="mt-4">Whether you're planning a Women's Day brunch, recognition ceremony, or community event—we’re here to make it beautiful, bold, and meaningful.</p>
          </>
        }
