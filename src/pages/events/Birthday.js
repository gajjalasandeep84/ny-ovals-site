...
export default function Birthdays() {
  ...
  useEffect(() => {
    const loadedImages = importAll(require.context("../../watermarked/images/birthday", false, /\.(png|jpe?g|svg)$/));
  ...
  return (
    <div className="font-serif">
      ...
      <IntroSection
        icon="🎂🎈🎉🎁"
        title="Celebrate Life's Milestones in Style"
        subtitle="From birthdays to graduations, we create joyful experiences with unforgettable decor."
      />
